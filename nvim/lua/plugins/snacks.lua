...
local keymaps = {
  -- Search
  { "<leader><leader>", function() snacks.picker.buffers() end, desc = "Search through buffers" },
  { "<leader>sf", function() snacks.picker.files() end, desc = "Find files" },
  { "<leader>sg", function() snacks.picker.grep() end, desc = "Grep" },
  { "<leader>s/", function() snacks.picker.grep_buffers() end, desc = "Grep open buffers" },
  { "<leader>sn", function() snacks.picker.files({ cwd = vim.fn.stdpath("config")}) end, desc = "Find editor config files" },
  { "<leader>sp", function() snacks.picker.projects() end, desc = "Projects" },
  -- Explorer
  { "<leader>se", function() snacks.explorer() end, desc = "File explorer" },
  -- Git
  { "<leader>ts", function() snacks.picker.git_status() end, desc = "Git status" },
  -- LSP
  { "<leader>gd", function() snacks.picker.lsp_definitions() end, desc = "Goto definition" },
  { "<leader>gD", function() snacks.picker.lsp_type_definitions() end, desc = "Goto type definition" },
  -- Buffers
  { "<leader>bd", function() snacks.bufdelete() end, desc = "Delete buffer" },
  -- Other
  { "<leader>uz", function() snacks.zen() end, desc = "Toggle zen mode" },
  { "<leader>uw", function() snacks.toggle.option("wrap", {name = "Wrap"}) end, desc = "Toggle wrap" },
  { "<leader>us", function() snacks.toggle.option("spell", {name = "Spelling"}) end, desc = "Toggle spellcheck" },
